              ...
              <div class="w-2/3">
                <div class="pr-28">
                  ...
                  <div class="mt-1 flex items-center rounded-md" v-for="(row, index) in columnRows" :key="index">
                    ...
                    <span class="w-[100px]">
                      <input type="radio" :name="row.column" class="ml-[42px] w-4 h-4" :checked="!isChecked(`${row.id}-`)" @change="handleCheck(row.id, 0)">
                    </span>
                    <span class="w-[100px]">
                      <input type="radio" :name="row.column" class="ml-[42px] w-4 h-4" :checked="isChecked(`${row.id}-1`)" @change="handleCheck(row.id, 1)">
                    </span>
                    <span class="w-[100px]">
                      <input type="radio" :name="row.column" class="ml-[42px] w-4 h-4" :checked="isChecked(`${row.id}-2`)" @change="handleCheck(row.id, 2)">
                    </span>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    isChecked(val) {
      const str = this.userRole.column_permissions.join(',');
